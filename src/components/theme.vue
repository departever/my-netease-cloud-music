<template>
  <div class="theme">
    <el-popover placement="top" v-model="visible" width="230">
      <div class="themes">
        <div v-for="(themeValue, themeKey, index) in themeMap" :key="index" @click="changeTheme(themeKey)" class="theme-item">
...
// 默认红色
const defaultTheme = storage.get(THEME_KEY, themes.red);
